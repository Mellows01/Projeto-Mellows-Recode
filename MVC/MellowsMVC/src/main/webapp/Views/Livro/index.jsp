<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="model.Livro" import="java.util.List"%>

<%
List<Livro> lista = (List<Livro>) request.getAttribute("livro");
%>
<!DOCTYPE html>
<html lang="pt-br">
...
<section class="container">
	<div class="p-4">
		<div class="row justify-content-center">
			<a href="./Views/Livro/create.jsp" class="btn mb-2 botao1"
				style="background-color: #FFA500"> Novo Livro</a>
		</div>
		...
		<table class="table table-responsive table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=l.getAutor()%></td>
					<td><%=l.getGenero()%></td>
					<td><%=l.getUsuario().getNome() %></td>
					<td>
						<div class="d-flex">
							<a href="update-livro?idlivros=<%=l.getIdLivro()%>"
								class="btn btn-primary" title="Editar"> Editar <i
								class="ri-file-edit-line"></i>
							</a> <a href="delete-livro?id=<%=l.getIdLivro()%>"
								class="btn btn-danger" title="Excluir"
								onclick="return confirm('Deseja excluir o Livro <%=l.getNomeLivro()%>?')">
								Excluir <i class="ri-delete-bin-2-line"></i>
							</a>
						</div>
					</td>
				</tr>
