...
<link rel="stylesheet" type="text/css" href="cadastre-se.css">
			...
			<form action="../../create-livro">
				...
				<div class="form-group mb-3">
					<label for="genero" class="form-label"> Gênero </label> <input
						type="text" id="genero" name="genero" class="form-control" required/>
				</div>
				<div class="form-group mb-3">
					<label for="idUsuario" class="form-label"> ID do Usuário </label> <input
						type="number" id="idUsuario" name="idUsuario" class="form-control" required/>
				</div>
