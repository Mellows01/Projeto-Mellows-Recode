...
<%
List<LI> listaLi = (List<LI>) request.getAttribute("li");
%>
<!DOCTYPE html>
<html lang="pt-br">
...
<section class="container">
	<div class="p-4">
		<div class="row justify-content-center">
			<a href="./Views/Li/create.jsp" class="btn mb-2 botao1"
				style="background-color: #FFA500"> Novo Livro Interativo </a>
		</div>
		...
		<table class="table table-responsive table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div class="d-flex">
							<a href="update-li?id=<%=l.getIdLi()%>"
								class="btn btn-primary" title="Editar"> Editar <i class="ri-file-edit-line"></i>
							</a> <a href="delete-li?id=<%=l.getIdLi()%>"
								class="btn btn-danger" title="Excluir"
								onclick="return confirm('Deseja excluir o L.Interativo <%=l.getNome()%>?')"> Excluir
