...
<nav class="navbar navbar-expand-lg mb-5" id="NavBar">
	...
	<div class="container py-3">
			<form action="./edit-usuario">
				<h2 class="text-center">Atualizar Usuário</h2>

				<div class="form-group mb-3">
					<label for="idUsuario" class="form-label"> ID Usuário </label> <input
				...
				<div class="form-group mb-3">
					...
					<div class="form-group mb-3">
					<label for="tipoLogin" class="form-label"> Tipo do Login </label><select
						class="form-select form-select-sm" name="idLogin" aria-label=".form-select-sm example">
